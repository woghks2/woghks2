<div align="right">
  <strong><a href="./README.md">KOR</a> | <a href="./README_EN.md">ENG</a></strong>
</div>
...
**사용자 행동 로그에서 문제를 정의하고, 가설과 실험을 통해 서비스 지표를 개선하는 데이터 분석가입니다.**

> *퍼널 분석을 통해 메인 페이지의 검색 진입 병목을 발견하고, 접근성 개선 A/B 테스트를 설계하여 상세 페이지 전환율(CVR)을 4.2%p 향상시켰습니다.*

단순한 데이터 분석을 넘어, 문제 정의부터 실험 설계, 검증, 개선까지 이어지는 데이터 기반 의사결정 과정을 직접 수행하며 사용자 경험을 개선해왔습니다.
